...
const TikTokDownloadForm = ({ language }) => {
  ...
  const translations = {
    ar: {
      ...
      videoUrl: 'رابط فيديو تيك توك',
      quality: 'جودة الفيديو',
      audioQuality: 'جودة الصوت',
      format: 'نوع الملف',
      downloadFrom: 'تحميل من تيك توك',
      pasteLink: 'الصق رابط تيك توك واختر الإعدادات',
      ...
      enterValidUrl: 'يرجى إدخال رابط تيك توك صحيح',
    ...
    en: {
      ...
      format: 'File Format',
      downloadFrom: 'Download from TikTok',
      pasteLink: 'Paste the TikTok link and choose your settings',
      ...
      enterValidUrl: 'Please enter a valid TikTok URL',
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.url.trim() || !formData.url.includes('tiktok.com')) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {isLoading && (
            <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden mb-4">
              <div
                className="h-full bg-gradient-to-r from-pink-500 to-purple-600 rounded-full transition-all duration-500 ease-out shadow-lg"
...
export default TikTokDownloadForm; 