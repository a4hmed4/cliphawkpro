...
const FacebookDownloadForm = ({ language }) => {
  ...
  const translations = {
    ar: {
      ...
      videoUrl: 'رابط فيديو فيسبوك',
      quality: 'جودة الفيديو',
      audioQuality: 'جودة الصوت',
      format: 'نوع الملف',
      downloadFrom: 'تحميل من فيسبوك',
      pasteLink: 'الصق رابط فيسبوك واختر الإعدادات',
      ...
      enterValidUrl: 'يرجى إدخال رابط فيسبوك صحيح',
    ...
    en: {
      ...
      format: 'File Format',
      downloadFrom: 'Download from Facebook',
      pasteLink: 'Paste the Facebook link and choose your settings',
      ...
      enterValidUrl: 'Please enter a valid Facebook URL',
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.url.trim() || !formData.url.includes('facebook.com')) {
...
export default FacebookDownloadForm; 